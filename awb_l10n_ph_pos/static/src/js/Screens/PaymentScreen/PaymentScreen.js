odoo.define('awb_l10n_ph_pos.PaymentScreen', function(require) {
    'use strict';
    ...
    const PaymentScreenInherit = PaymentScreen =>
        class extends PaymentScreen{
            //altered this one so that we fetch the final discount as well as
            //the final pricelist to be pushed into the backend once
            //and alter the current discount.
            //this prevents the computation from triggering repeatedly

            async _finalizeValidation() {
                console.log("PaymentScreen inherited");
                ...
                //added function in Order that will consider the pricelist as well as 
                //the manual discount and recalculate the total discount to be saved
//                this.currentOrder.recalculate_discount();
